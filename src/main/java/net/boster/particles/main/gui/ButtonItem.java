...
public class ButtonItem implements GUIButton {
    ...
    public @Nullable ClickActions successfulActions;
    public @Nullable ClickActions noPermissionActions;
    ...
    public static class ClickActions {
        ...
        public ClickActions(@NotNull ButtonItem i, @Nullable BosterSound sound, @NotNull List<String> messages, @NotNull List<String> commands, @NotNull List<String> announce, boolean clearFile, @NotNull List<String> clearSections, @Nullable ConfigurationSection setToFile) {
            this.item = i;
            this.sound = sound;
