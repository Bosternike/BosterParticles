...
public class MenuSectionEditGUI {
    ...
    private static List<MultiPageFunctionalEntry> createButtons(@NotNull ParticlesGUI particlesGUI, @NotNull ConfigurationSection section) {
        ...
        list.add(getEntry(particlesGUI, section, "cost", new DoubleTranslator()));
        list.add(getEntry(particlesGUI, section, "slot", new IntegerTranslator()));
        list.add(getEntry(particlesGUI, section, "blank", new BooleanTranslator()));
        list.add(getEntry(particlesGUI, section, "material", new MaterialTranslator()));
        list.add(getEntry(particlesGUI, section, "skull", null));
        list.add(getEntry(particlesGUI, section, "head", null));
        list.add(getEntry(particlesGUI, section, "name", null));
        list.add(getEntry(particlesGUI, section, "success_actions.sound", new BosterSoundTranslator()));
        list.add(getEntry(particlesGUI, section, "no_permission_actions.sound", new BosterSoundTranslator()));
        list.add(getEntry(particlesGUI, section, "not_enough_money_actions.sound", new BosterSoundTranslator()));

        return list;
    }

    private static <T> MultiPageFunctionalEntry getEntry(@NotNull ParticlesGUI particlesGUI, @NotNull ConfigurationSection section, @NotNull String path, @Nullable ITranslator translator) {
